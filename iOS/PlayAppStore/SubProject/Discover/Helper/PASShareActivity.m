...
@implementation PASShareActivity
...
//    //用safari打开网址
//    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://github.com/endust"]];
//    
//    //这里就可以关联外面的app进行分享操作了
//    //也可以进行一些数据的保存等操作
//    //操作的最后必须使用下面方法告诉系统分享结束了
//    [self activityDidFinish:YES];
    if (self.delegate && [self.delegate respondsToSelector:@selector(qrCodeTaped)]) {
        [self.delegate qrCodeTaped];
    }

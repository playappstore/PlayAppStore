...
- (UIBezierPath *)pathForBox {
    ...
    switch (self.boxType) {
        ...
        default: {
            ...
            path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(self.size / 2.0, self.size / 2.0)
                                                  radius: radius
                                              startAngle: - M_PI / 4.0
                                                endAngle:  2 * M_PI - M_PI / 4.0
                                               clockwise:YES];
        }
            break;
    }
...
- (UIBezierPath *)pathForPlusSign {
    UIBezierPath* checkMarkPath = [UIBezierPath bezierPath];
    [checkMarkPath moveToPoint: CGPointMake(self.size/2.0 - 5, self.size/2.0)];
    [checkMarkPath addLineToPoint: CGPointMake(self.size/2.0 + 5, self.size/2.0)];
    [checkMarkPath moveToPoint: CGPointMake(self.size/2.0 , self.size/2.0 - 5)];
    [checkMarkPath addLineToPoint: CGPointMake(self.size/2.0, self.size/2.0 + 5)];
